...
namespace DataverseFakes.Tests.FakeContextTests
{
    public class XrmFakedRelationshipTests
    {
        ...
        public void When_creating_relationship_with_first_constructor_properties_are_set_correctly()
        {
            ...
            Assert.Equal(XrmFakedRelationship.enmFakeRelationshipType.OneToMany, rel.RelationshipType);
        }
        ...
        public void When_creating_relationship_with_second_constructor_properties_are_set_correctly()
        {
            ...
            Assert.Equal(XrmFakedRelationship.enmFakeRelationshipType.ManyToMany, rel.RelationshipType);
        }
